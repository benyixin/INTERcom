...
// CServeroneDlg 消息处理程序

BOOL CServeroneDlg::OnInitDialog()
{
...
void CServeroneDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CServeroneDlg::OnQueryDragIcon()
{
